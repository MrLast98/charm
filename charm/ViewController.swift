...
class ViewController: UIViewController {
    ...
    weak var gameActionButton: GameActionButton!
    ...
    weak var menuImageView: UIImageView!
    
    /// The game controller, which manages game state.
    var gameController: Prova.GameController!
    
    /// The app's main view.
    var overlayView: ContentView!
    ...
    override func viewDidLoad() {
        ...
        gameController = Prova.GameController(observer: self)
    ...
    @IBAction func gameActionButtonPressed(_ gameActionButton: GameActionButton) {
        ...
        case .retry:
            ...
            if gameController.gameAnchor != nil {
                ...
                let anchorPlacement = Prova.AnchorPlacement(arAnchorIdentifier: anchorEntity?.anchorIdentifier,
    ...
    func restart(_ game: Prova.Qubo) {
...
extension ViewController: GameControllerObserver {
    func gameControllerContentDidLoad(_ gameController: Prova.GameController) {
...
//        }
        ...
        if let anchorPlacement = self.gameController.anchorPlacement {
            ...
            game.anchoring = AnchoringComponent(.plane(.vertical, classification: .any, minimumBounds: SIMD2<Float>(0, 0)))
        }
...
//
    func gameControllerReadyForPlayer(_ gameController: Prova.GameController) {
        menuImageView.isHidden = false
        gameActionButton.gameAction = .tapToPlay
        gameActionButton.isHidden = false
    }

    func gameControllerReadyForContentPlacement(_ gameController: Prova.GameController) {
    ...
    func gameController(_ gameController: Prova.GameController, readyForPlayerToBowlGame gameNumber: Int) {
        guard let game = gameController.gameAnchor else { return }
...
//            }.store(in: &collisionEventStreams)
    ...
    func gameController(_ gameController: Prova.GameController, completedBowlingFrameWithStruckPins struckPinCount: Int) {
